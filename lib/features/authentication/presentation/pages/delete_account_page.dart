  ...
  Future<void> _deleteAccount() async {
    ...
    try {
      ...
      final success = await DeleteAccountService.deleteAccount(
        password: _isGoogleUser ? null : _passwordController.text,
        reason: reason,
      );
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          ...
          style: TextStyle(color: Color(0xFF4A5C54), height: 1.5),
        ),
        actions: [
          TextButton(
            onPressed: () {
  ...
  void _showErrorDialog(String message) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          message,
          style: const TextStyle(color: Color(0xFF4A5C54), height: 1.5),
        ),
        actions: [
          TextButton(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: DeleteAccountService.deletionReasons
                        .map(
                          (reason) => Container(
                            decoration: BoxDecoration(
                              border:
                                  reason !=
                                      DeleteAccountService.deletionReasons.last
                                  ? const Border(
                                      bottom: BorderSide(
                ...
                if (_isGoogleUser) ...[
                  ...
                  Container(
                    ...
                    child: const Text(
                      'Google 계정으로 로그인한 사용자이므로 비밀번호 입력 없이 탈퇴할 수 있습니다.',
                      style: TextStyle(color: Color(0xFF4A5C54), height: 1.5),
                    ),
                  ),
                ] else ...[
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed:
                        _isLoading || !_hasAgreed || _selectedReason == null
                        ? null
                        : _showConfirmDialog,
